...
def process_loco(loco_dir='experiments/LOCO'):
    ...
    experiment_string = '{} with{} kataegis with {} signatures'
...
def process_sample_cv(sample_cv_dir='experiments/sampleCV'):
    experiment_string = '{}fold CV on {} with{} kataegis with {} signatures'
                ...
                for model in os.listdir(os.path.join(dataset_dir, signature_learning, kataegis_usage)):
                    for num_sigs in os.listdir(os.path.join(dataset_dir, signature_learning, kataegis_usage, model)):
                        ...
                        for num_folds in total_folds:
                            curr_experiment_string = experiment_string.format(num_folds, model, kataegis_string, signatures_string)
...
process_loco('../experiments/LOCO')
process_sample_cv('../experiments/sampleCV')
# process_trained_models('../experiments/trained_models')
